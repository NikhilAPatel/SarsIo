...
function Powerups() {
    ...
    this.setup = function(){
        this.SaHOButton = createImg('img/home.png'); //0
        this.MIButton = createImg('img/moneyInjection.png'); //1
        this.maskButton = createImg('img/mask.png'); //2
        this.vaccineButton = createImg('img/vaccine.png'); //3
        this.testButton = createImg('img/test.svg'); //4
    ...
    this.show = function () {
        ...
        this.barX = (tester.pos.x - this.length/2);
        this.barY =(tester.pos.y + height / 2 - 10 - this.height);
